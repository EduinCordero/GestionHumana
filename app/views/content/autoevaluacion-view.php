...
<div class="ev-wrap">
    <div class="ev-card">
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;
            ...
            <div>
                <div style="font-size:1rem;font-weight:800;color:var(--ev-text);">Autoevaluación de Desempeño</div>
...
<script>
    ...
    function evNext(current, total) {
        ...
        // Mostrar modal informativo al entrar a nueva dimensión
    ...
    // ── Modales informativos por dimensión ───────────────────────────────────
    const evSecciones = {
        ...
        9:  { icon: '<i class="ti ti-rocket" style="font-size:2rem;color:#0058af;"></i>', title: 'Potenciando el Impacto en tus Funciones Específicas', text: 'En esta sección, queremos ir más allá del simple cumplimiento de tareas: buscamos descubrir cómo tu talento transforma la rutina en resultados extraordinarios. Evaluaremos cómo tu desempeño impulsa un entorno de colaboración positiva y cómo aprovechas al máximo tu tiempo y recursos.' },
    };

    function mostrarSectionModal(seccion) {
        const key = 'evModal_auto_' + seccion;
    ...
    // Mostrar al cargar la página (sección 1)
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const key = 'evModal_auto_bienvenida';
