$(function () {
    ...
    function addContact() {
        $("#btn-add").click(function () {
            ...
            // var $_phone = getParent.find("#c-identificacion");
            ...
            if ($_nameValue == "") {
                $_getValidationField[0].innerHTML = "Se debe completar el nombre";
           ...
           /*  if ($_emailValue == "") {
                $_getValidationField[1].innerHTML = "Se debe completar la identificación del correo electrónico";
                $_getValidationField[1].style.display = "block";
            } else if (reg.test($_emailValue) == false) {
                $_getValidationField[1].innerHTML = "Correo electrónico no válido";
                $_getValidationField[1].style.display = "block";
            } else {
            ...
            if ($_phoneValue == "") {
                $_getValidationField[2].innerHTML = "Inválida (ingrese 10 dígitos)";
                $_getValidationField[2].style.display = "block";
            } else if (phoneReg.test($_phoneValue) == false) {
                $_getValidationField[2].innerHTML = "Por favor ingrese un valor numérico";
                $_getValidationField[2].style.display = "block";
            } else {
...
getEmailInput.addEventListener("input", function () {
    ...
    if (getEmailInputValue == "") {
        $_getValidationField[1].innerHTML = "Correo electrónico requerido";
        $_getValidationField[1].style.display = "block";
...
getPhoneInput = document.getElementById("c-identificacion");

getPhoneInput.addEventListener("input", function () {
    getPhoneInputValue = this.value;

    if (getPhoneInputValue == "") {
        $_getValidationField[2].innerHTML = "Identificacion requerida";
        $_getValidationField[2].style.display = "block";
    } else if (phoneReg.test(getPhoneInputValue) == false) {
        $_getValidationField[2].innerHTML = "Invalido (Enter max 10 Digits)";
        $_getValidationField[2].style.display = "block";
    } else {
        $_getValidationField[2].style.display = "none";
    }
